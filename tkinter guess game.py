...
Label(window, text="Guess a number between 1 and 100",font=('keep on truckin',20), fg='blue').pack()
...
Button(window, text="check", command=check_guess,background='blue',foreground='white').pack()
